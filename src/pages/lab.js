  ...
  <StandardPage>
    ...
    <ReadableSection wide>
      ...
      <LabFeature
        ...
        image={
          <Img
            sizes={ data.backgroundBumps.sizes }
          />
        }
...
query IndexQuery {
  ...
  echoplexus: imageSharp(id: { regex: "/echoplexus/img/echoplexus-latest.png/" }) {
    sizes(maxWidth: 601, quality: 90) {
    ...GatsbyImageSharpSizes_tracedSVG
    }
  }
  backgroundBumps: imageSharp(id: { regex: "/webgl-background-bump-mapping/img/background-bumps.jpg/" }) {
    sizes(maxWidth: 601, quality: 90) {
    ...GatsbyImageSharpSizes_tracedSVG
    }
  }
  perlin: imageSharp(id: { regex: "/animating-functions-of-improved-3d-perlin-noise/img/gpu-perlin4.png/" }) {
    sizes(maxWidth: 601, quality: 90) {
    ...GatsbyImageSharpSizes_tracedSVG
    }
  }
  raytracer: imageSharp(id: { regex: "/cs488-raytracer/img/final_scene.png/" }) {
    sizes(maxWidth: 601, quality: 90) {
    ...GatsbyImageSharpSizes_tracedSVG
    }
  }
