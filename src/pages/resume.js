...
const IndexPage = () => (
  <StandardPage>
    ...
    <ReadableSection>
      ...
      <section id='title'>
        <p>I'm a software developer with a passion for the web and computer graphics.</p>
      ...
      <section id='work-experience'>
        ...
        <div className='resume__job'>
          ...
          <p>
            I worked with the client-side MVC framework <a href='http://batmanjs.org/' target='_blank' title='Batman.js homepage'>Batman.js</a> before we started to move to a custom in-house server-client hybrid approach.  This launched me from no previous CoffeeScript experience to relative expertise, imparting in me a thorough love of the language.
          </p>
          <p>My role shifted from front-end to full-stack in our transition:  As a team of 8~10, we've developed a powerful system that allows the server to be the primary source of truth in rendering, but still gives us enough flexibility that at first glance, you might think we've made a single-page app.  It drastically reduced our mean development time for new features, and greatly simplified bug fixes.  Everybody loved it, and <a href="https://www.shopify.ca/technology/15646068-rebuilding-the-shopify-admin-improving-developer-productivity-by-deleting-28-000-lines-of-javascript" title="Rebuilding the Shopify Admin: Improving Developer Productivity by Deleting 28,000 lines of JavaScript" target="_blank">we were quite proud of it.</a></p>
          <p>I loved our new web paradigm so much that I extracted it into 2 open source libraries, <a href="https://github.com/Shopify/twine" title="External link to Twine on GitHub" target="_blank">Twine</a> and <a href="https://github.com/Shopify/turbograft" title="External link to TurboGraft on GitHub" target="_blank">TurboGraft</a>.</p>
          <p>After that, I was working in our new Waterloo office on Plus engineering efforts.  I was responding to a variety of engineering efforts that affect our Plus merchants: new features, bug triage / acceleration.  I was responsible for building out most of the infrastructure our sales team used to do their job at the time, and also created some in-office TV dashboards that displayed live sales data (among other things).</p>
          <p>Since around May 2016, I've been 100% working from home in Waterloo.  I spent approximately 1 year in the Shipping team, and delivered: an improved shipping zones UI, and allowing all Shopify merchants access to <a href="https://www.shopify.ca/blog/calculated-shipping-rates-for-everyone" title="Shopify Shipping Brings Calculated Rates to All Shopify Plans " target="_blank">Shopify Shipping carrier-calculated rates</a>.  I also championed our <a href="https://www.shopify.ca/blog/bulk-label-printing" title="Introducing Bulk Label Printing for Shopify Shipping" target="_blank">bulk label printing</a> project, a new user flow that allows merchants to buy & print multiple shipping labels at a time.</p>
          <p>Nowadays, some Shipping teammates and I have splintered off to form a new team, but I'm not permitted to speak too much about it at this time!</p>
        </div>
        <div className='resume__job'>
          <Resume.Position
      ...
      <section id='education'>
        ...
        <p>
          <strong>Awards:</strong> University of Waterloo Merit Scholarship, 2006
        </p>
      </section>
      <section id='projects'>
        <Typography.PageSubtitle>Personal Projects & Open Source</Typography.PageSubtitle>
        <p>In my spare time, I'm either playing video games, spending time with my wife, or working on software.</p>
        <h4>echoplexus</h4>
        <p>
          <a href='https://github.com/qq99/echoplexus' target='_blank' title='echoplexus on GitHub'>echoplexus</a> was perhaps my most substantial and successful personal project to date.  It aimed to provide web-based anonymous chat, collaborative coding and drawing, as well as WebRTC audio & video calls.
        </p>
        <h4>μv</h4>
        <p>
          <a href='https://github.com/qq99/muvee' target='_blank' title='μv on GitHub'>μv</a> (pronounced mew-vee) is a Rails 4 application that I've recently started working on in hopes of replacing <a href='http://xbmc.org/' target='_blank' title='XBMC homepage'>XBMC</a> as my home streaming system.  Right now, it's able to query external datasources (<a href='http://thetvdb.com/' target='_blank' title='thetvdb.com homepage'>thetvdb.com</a>, <a href='http://www.omdbapi.com/' target='_blank' title='omdb homepage'>omdb</a>), gather metadata, download posters, and generate screenshots from video files.  It groups episodes by series and displays a Netflix-esque interface, streaming video down to any web client in your home.
        </p>
        <h4>Others</h4>
        <p>
          Please visit <a href='https://anthonycameron.com'>https://anthonycameron.com</a> for an overview of some things I've worked on.
        </p>
        <p>
          I also contribute to OSS (my own and others) <a href='https://github.com/qq99?tab=repositories' target='_blank' title='My work on GitHub'>on GitHub.</a>
        </p>
      </section>
    </ReadableSection>
  </StandardPage>
